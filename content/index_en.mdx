...
The Advisory Board has reviewed all applications and has now sent out all acceptances, which have also been confirmed by all projects.
Unfortunately, not all cancellations could be sent by e-mail. If you have not received a confirmation by now, your project could not be funded.
